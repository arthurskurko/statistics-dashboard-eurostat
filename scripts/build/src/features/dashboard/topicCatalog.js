...
exports.TOPIC_MAP = exports.TOPICS = void 0;
exports.TOPICS = [
    {
        id: 'population',
        title: 'Population',
    ...
    },
    {
        ...
        description: 'Seasonally adjusted unemployment rate for ages 25-74, Estonia versus the EU aggregate.',
    ...
    },
    {
        ...
        unitSuffix: '%',
        chartVariant: 'line',
        sourceUrl: 'https://ec.europa.eu/eurostat/databrowser/view/prc_hicp_manr/default/table?lang=en',
    },
    {
        id: 'immigration',
        title: 'Immigration',
        ...
        decimals: 0,
        chartVariant: 'line',
        sourceUrl: 'https://ec.europa.eu/eurostat/databrowser/view/migr_imm1ctz/default/table?lang=en',
    },
    {
        ...
        decimals: 0,
        chartVariant: 'line',
        sourceUrl: 'https://ec.europa.eu/eurostat/databrowser/view/DEMO_FABORTORD/default/table?lang=en',
    },
    {
        id: 'gdp-per-capita',
        title: 'GDP per capita',
        description: 'Real GDP per capita in chain linked volumes (2010), Estonia compared with the EU aggregate.',
...
exports.TOPIC_MAP = Object.fromEntries(exports.TOPICS.map((topic) => [topic.id, topic]));
